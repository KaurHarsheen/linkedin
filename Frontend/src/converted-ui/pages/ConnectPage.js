...
import { X, Send, Paperclip, Smile, Phone, Video, MoreVertical, Sparkles } from 'lucide-react';
      ...
      <div className="bg-white text-[#202A44] dark:bg-black dark:text-white rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center space-x-1">
            <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><Phone className="w-4 h-4" /></button>
            <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><Video className="w-4 h-4" /></button>
            <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><MoreVertical className="w-4 h-4" /></button>
            <button onClick={onClose} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><X className="w-4 h-4" /></button>
          </div>
        </div>
        ...
        {showAiHelper && (
          <div className="border-t border-gray-200 dark:border-gray-700 p-4 bg-gray-50 dark:bg-gray-800">
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => setShowAiHelper(false)} className="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">
                <X className="w-4 h-4" />
              </button>
            </div>
            <textarea
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-2">
            <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full"><Paperclip className="w-5 h-5" /></button>
            <button
              onClick={() => setShowAiHelper(!showAiHelper)}
              className={`p-2 rounded-full ${
                showAiHelper ? 'bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-400' : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400'
              }`}
              ...
              <div className="flex items-center space-x-4 mb-6">
                <div className="relative">
                  ...
                  <div className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-2 border-white dark:border-gray-900 ${
                    person.status === 'online' ? 'bg-green-500' : 'bg-yellow-500'
                  }`} />
                </div>
                <div>
                  <h3 className="text-xl font-bold">{person.name}</h3>
                  <p className="text-gray-600 dark:text-gray-400 font-medium">{person.role}</p>
                </div>
              </div>
